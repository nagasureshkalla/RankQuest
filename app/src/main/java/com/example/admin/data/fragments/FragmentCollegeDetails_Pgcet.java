...
public class FragmentCollegeDetails_Pgcet extends Fragment {
    ...
    public FragmentCollegeDetails_Pgcet(){
    ...
    public static FragmentCollegeDetails_Pgcet newInstance(CollegeBranchDetails branchDetails) {
        ...
        FragmentCollegeDetails_Pgcet fragment = new FragmentCollegeDetails_Pgcet();

...
public class Fragment_Checklist_Pgcet extends Fragment {
    RecyclerView r;
    TabLayout tabLayout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_fragment__checklist__pgcet, container, false);
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    ...
                    return new Fragment_Checklist_Pgcet_Main();
                case 1:

                    return new Fragment_Reportingcenters_Pgcet();
                default:
                    return null;
            }

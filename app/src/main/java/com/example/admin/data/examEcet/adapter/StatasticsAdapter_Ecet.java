...
public class StatasticsAdapter_Ecet extends RecyclerView.Adapter<StatasticsAdapter_Ecet.ViewHolder> implements FastScrollRecyclerViewInterface{
    ...
    public StatasticsAdapter_Ecet(List<CollegeDetails> lis,HashMap<String, Integer> map,OnItemClick click, Context context) {
        this.lis=lis;
        this.click=click;
    ...
    @Override
    public StatasticsAdapter_Ecet.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                   int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclecolleges, parent,false);
        return new StatasticsAdapter_Ecet.ViewHolder(view);
    }

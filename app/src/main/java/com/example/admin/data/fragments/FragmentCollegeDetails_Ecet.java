...
public class FragmentCollegeDetails_Ecet extends Fragment {
    ...
    public FragmentCollegeDetails_Ecet(){
    ...
    public static FragmentCollegeDetails_Ecet newInstance(CollegeBranchDetails branchDetails) {
        ...
        FragmentCollegeDetails_Ecet fragment = new FragmentCollegeDetails_Ecet();

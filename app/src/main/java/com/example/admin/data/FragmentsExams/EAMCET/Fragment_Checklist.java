...
public class Fragment_Checklist extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_fragment__checklist, container, false);
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    ...
                    return new Fragment_Checklist_Eamcet();
                case 1:

                    return new Fragment_Reportingcenters_Eamcet();
                default:
                    return null;
            }
